...
# Format: IMG_YYYYMMDD_HHMMSS.<ext> or IMG_YYYYMMDD_HHMMSS_noexif.<ext> (with optional _2, _3 suffix)
FILENAME_PATTERN = r"^IMG_\d{8}_\d{6}(_noexif)?(_\d+)?\.(jpg|heif|png)$"

# Filename pattern for valid video names
# Format: VID_YYYYMMDD_HHMMSS.mp4 or VID_YYYYMMDD_HHMMSS_nometa.mp4 (with optional _2, _3 suffix)
VIDEO_FILENAME_PATTERN = r"^VID_\d{8}_\d{6}(_nometa)?(_\d+)?\.mp4$"
